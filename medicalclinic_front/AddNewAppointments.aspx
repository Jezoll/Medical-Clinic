       ...
       <div style="height: 92.4vh; width: 80vw; border: 5px solid #507CD1; border-top-color: white; border-bottom-color: white"> 
           ...
           <div style="margin-left: 26vw; border: solid; border-color: #EDF1F9; width: 40%; float: left";>
                <div style="margin-top: 1vh; clear: both">
                    ...
                    <asp:DropDownList CssClass="DropDownList" ID="DropDownList_Patient" runat="server"></asp:DropDownList>
                </div>
                <div style="clear: both">
                    <asp:Label CssClass="Label" ID="Label1" runat="server" Text="Date:"></asp:Label>
                    <asp:TextBox CssClass="TextBox" ID="TextBox_Date" TextMode="Date" runat="server"></asp:TextBox>
                </div>
                    <asp:Label CssClass="Label" ID="Label2" runat="server" Text="Time:"></asp:Label>
                    <asp:TextBox CssClass="TextBox" ID="TextBox_Time" TextMode="Time" runat="server"></asp:TextBox>
                <div style="clear: both">
                    ...
                    <asp:DropDownList CssClass="DropDownList" ID="DropDownList_Doctor" runat="server" ></asp:DropDownList>
                <div style="clear: both">
                    <asp:Label CssClass="Label" ID="Label5" runat="server" Text="Office:"></asp:Label>
                    <asp:DropDownList CssClass="DropDownList" ID="DropDownList_Office" runat="server"></asp:DropDownList>
                </div>
                    <asp:Label CssClass="Label" ID="Label6" runat="server" Text="Visit duration:"></asp:Label>
                    <asp:TextBox CssClass="TextBox" ID="TextBox_Duration" TextMode="Number" runat="server" min="1"></asp:TextBox>
                <div style="clear: both">
                    <asp:Label CssClass="Label" ID="Label7" runat="server" Text="Payment:"></asp:Label>
                    <asp:TextBox CssClass="TextBox" ID="TextBox_Payment" runat="server"></asp:TextBox>
                </div>
                <div style="clear: both">
                    <asp:Label CssClass="Label" ID="Label8" runat="server" Text="Description:"></asp:Label>
                    <asp:TextBox CssClass="Description" ID="TextBox_Description" runat="server"></asp:TextBox>
                </div>
