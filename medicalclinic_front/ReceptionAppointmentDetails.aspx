...
<center>
 <div style="height: 92.4vh; width: 80vw; border: 5px solid #507CD1; border-top-color: white; border-bottom-color: white">
    ...
    <div style="clear: both">
        <asp:Label CssClass="Label" ID="Label_duration" runat="server" Text="Duration: " Font-Names="Arial" Font-Size="12pt" width="110pt"></asp:Label>
        <asp:Label CssClass="Label_value" ID="Label_duration_value" runat="server" Text="Label"></asp:Label>
    </div>
     <div style="clear: both">
    ...
    <div>
        ...
        <asp:Label CssClass="Title" ID="Label_reshedule" runat="server" Text="Reshedule appointment:" Font-Names="Arial" Font-Size="18pt"></asp:Label>
        <div style="margin-left: 26vw; border: solid; border-color: #EDF1F9; width: 35%; float: left";>
    <div style="clear: both">
        ...
        <asp:TextBox CssClass="TextBox" ID="TextBox_ndate" runat="server" MaxLength="10" TextMode="Date"></asp:TextBox>
    </div>
     <div style="clear: both">
        ...
        <asp:TextBox CssClass="TextBox" ID="TextBox_ntime_value" runat="server" MaxLength="10" TextMode="Time"></asp:TextBox>
    </div>
    </div>
     <div style="clear: both">
        <asp:Button CssClass="Button" ID="Button_cancel" runat="server" OnClick="Button_Cancel_Click" OnClientClick ="return CancelAlertFunction()" Text="Cancel" />
        <asp:HiddenField ID="ConfirmMessageResponseDelete" runat="server" ClientIDMode="Static" />
    </div>
    <div style="clear: both">
        <asp:Button CssClass="Button" ID="Button_reshedule" runat="server" OnClientClick ="return ResheduleAlertFunction()" Text="Reshedule" OnClick="Button_Reshedule_Click" />
